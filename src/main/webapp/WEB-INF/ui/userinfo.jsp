...
<body>
	<form action="userdetailsvies" method="post"
		...
		<div class="form-group">
			<label for="exampleInputPassword1">Age</label> <input type="number"
				class="form-control" id="exampleInputPassword1" name="age">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="addharno">Addhar Number</label> <input
				type="number" class="form-control" id="addharno"
				name="addharno">
		</div>
		<div class="form-group">
			<label for="exampleInputPassword1">Date</label> <input type="date"
				class="form-control" id="exampleInputPassword1" name="vacdate">
		</div>
		<div class="form-group">
